    ...
    <footer className="  bottom-0 bg-[#021214] border-t-[0.1rem] border-t-gray-800 w-full py-6 ">
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between mt-6 px-4 gap-4">
        <div className="flex flex-wrap gap-4 items-center">
          ...
          <div className="flex gap-4 justify-center md:justify-start items-center">
            {[
              "https://lgi-img-cdn-lb.lionsgateplay.com/prd-peg-data/default/images/store-apple.svg",
              "https://lgi-img-cdn-lb.lionsgateplay.com/prd-peg-data/default/images/store-googleplay.svg",
            ].map((src, index) => (
              <img
                key={index}
